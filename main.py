...
"""
from labapp.processor.dataprocessorfactory import *    # подключаем фабрику обработчиков данных
...
"""
DATASOURCE1 = "labapp/source_files/user.csv"
DATASOURCE2 = "labapp/source_files/resume.csv"
DATASOURCE3 = "labapp/source_files/vacancy.csv"
...
def insert():
    ...
    if result3 is not None:
        ...
        print(select_all_from_vacancy(db_connector))  # вывод списка всеъ обработанных файлов
