from server.processor.dataprocessorfactory import *    # подключаем фабрику обработчиков данных
from server.repository.connectorfactory import *       # подключаем фабрику коннекторов к БД
from server.repository.sql_api import *                # подключаем API для работы с БД
